package pers.julio.notepad.SuperUtils.Demo.MyUtils;
...
/**
 * ClassName:  MySpUtils000
 * Description:
 * Author;  julio_chan  2020/1/16 18:23
 */
public class MySpUtils000 extends SpUtils {
    ...
    public static void removeItem(Context context, String key) {
        removeItem(context, pers.julio.notepad.SuperUtils.Demo.MyUtils.MySpUtils000.FILE_DOHOME,key);
    }
    ...
    public static void putInt(Context context, String key, int value) {
        putInt(context, pers.julio.notepad.SuperUtils.Demo.MyUtils.MySpUtils000.FILE_SP,key,value);
    }
